...
class DB(object):
    ...
    def insert(self, data):
        print(data)
        sql = 'INSERT INTO `stock_neeq_daily_data` (`sse_a_total`, `sse_a_tj`, `sse_b_total`, `sse_b_tj`, `sse_total`, `sse_tj_total`, `szse_total`, `szse_tj`, `neeq_total`, `neeq_tj`, `updated_date`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'
